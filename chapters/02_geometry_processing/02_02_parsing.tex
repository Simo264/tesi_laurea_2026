...
Il parsing viene realizzato in C++ mediante la libreria libdxfrw \cite{libdxfrw}, che fornisce un'interfaccia per la lettura dei file DXF. La classe del parser implementa le callback necessarie per gestire i diversi tipi di entità:
