...
\begin{document}
    \begin{titlepage}
        ...
        \begin{center}
            \includegraphics[width=8cm]{figures/unimore/Sigillo2015.png}
            \vspace{1cm}
            ...
            \vspace{3cm}
            {\Large { \textbf{Implementazione di una pipeline per la generazione di mesh 3D a partire da modelli CAD 2D di planimetrie architettoniche} }}\\
            \vspace{3cm}
        \end{center}
    ...
    \include{chapters/2_background_teorico/main}
    %\include{chapters/3_progettazione_pipeline/main}
    %\include{chapters/4_rendering/main}
